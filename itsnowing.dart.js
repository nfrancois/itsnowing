...
"%":"CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"},
yE:{
"^":"Gv;",
...
$isD0:true,
static:{"^":"Wt,S4,dk,Lo,z2,b2,jS,Ie,Do,Pu,kT,IJ,D9,Vk,S8,yn",k5:function(a,b,c,d,e,f){return new P.D0(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:19;",
...
"%":"DOMException"},
IB:{
"^":"Gv;OR:bottom=,fg:height=,Bb:left=,T8:right=,G6:top=,R:width=,y=",
...
gvL:function(a){return H.VM(new W.Cq(a,"loadedmetadata",!1),[null])},
$iscv:true,
"%":";Element"},
Fs:{
...
"%":"HTMLMapElement"},
El:{
"^":"qE;DE:autoplay},kc:error=,LA:src}",
...
return y.MM},
zH:function(a,b){return this.TM(a,!1,b)},
...
GE:{
"^":"Tp:10;a",
$1:function(a){return a.h(0,this.a)}}}],["","",,G,{
"^":"",
Iq:[function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=document.querySelector("#canvasSnow")
y=document.querySelector("#flakesRange")
x=document.querySelector("#takePhoto")
w=document.querySelector("#webcam")
v=document.querySelector("#photoBuffer")
u=document.querySelector("#photoContent")
t=document.querySelector("#content")
s=document.querySelector("#acceptVideo")
r=document.querySelector("#versionInfo")
q=J.Vg(x)
H.VM(new W.xC(0,q.J6,q.fA,W.VF(new G.em(z,w,v,u)),q.el),[H.Kp(q,0)]).DN()
q=J.RE(y)
p=G.a6(J.uP(z),z.width,z.height,H.Hp(q.gP(y),null,null))
q=q.gi9(y)
H.VM(new W.xC(0,q.J6,q.fA,W.VF(new G.Lb(y,p)),q.el),[H.Kp(q,0)]).DN()
q=J.Ks(window.navigator,!0)
o=new G.QA()
n=H.VM(new P.vs(0,$.X3,null),[null])
m=n.t9
if(m!==C.NU)o=P.VH(o,m)
q.xf(new P.Fe(null,n,2,null,o))
q.ml(new G.Cv(w,t,s,r,p))},"$0","KW",0,0,2],
em:{
"^":"Tp:10;a,b,c,d",
...
if(w!=null)J.Mp(w)
v=J.uP(y)
v.drawImage(this.b,0,0)
v.drawImage(z,0,0)
u=y.toDataURL("image/png",null)
t=W.r3("img",null)
x.appendChild(t)
y=J.RE(z)
x=y.gfg(z)
...
Lb:{
"^":"Tp:10;e,f",
$1:function(a){var z=H.Hp(J.Vm(this.e),null,null)
this.f.dg=z
return z}},
QA:{
"^":"Tp:10;",
$1:function(a){var z,y
J.pP(document.querySelector("#acceptVideo")).h(0,"hide")
z=document.querySelector("#error")
y=J.RE(z)
y.shf(z,"Unable to access the camera. Did you have one ?")
y.gDD(z).Rz(0,"hide")
return}},
Cv:{
"^":"Tp:23;UI,bK,Gq,Rm,w3",
$1:function(a){var z,y
z=this.UI
y=J.RE(z)
y.sDE(z,!0)
...
z=y.gvL(z)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new G.VW(this.bK,this.Gq,this.Rm,this.w3)),z.el),[H.Kp(z,0)]).DN()}},
VW:{
"^":"Tp:10;HZ,mG,xC,cj",
$1:function(a){J.pP(this.xC).h(0,"hide")
J.pP(this.mG).h(0,"hide")
J.pP(this.HZ).Rz(0,"hide")
C.ol.gm6(window).ml(this.cj.ght())
return}},
fP:{
"^":"a;dg,Ee,R,If,bX,WC",
pw:function(){this.bX.push(new G.Ig(this.WC.j1(5)+2,this.WC.j1(3),this.WC.j1(5)+2,this.WC.j1(this.R),this.WC.j1(this.If)))},
mH:[function(a){this.T1()
C.ol.gm6(window).ml(this.ght())},"$1","ght",2,0,24],
T1:function(){var z,y,x,w,v
z=this.Ee
z.clearRect(0,0,this.R,this.If)
for(y=this.bX,x=new H.a7(y,y.length,0,null);x.G();){w=x.lo
w.Am(z)
w.JG()}H.Ap(y,new G.RX(this))
v=0
while(!0){z=J.xH(this.dg,y.length)
...
if(!(z<y))break
this.pw();++z}},
static:{a6:function(a,b,c,d){var z=new G.fP(d,a,b,c,[],null)
z.Tb(a,b,c,d)
return z}}},
RX:{
"^":"Tp:25;a",
...
Am:function(a){a.beginPath()
a.arc(this.x,this.y,this.tL,0,6.283185307179586,!1)
a.fillStyle="#FFF"
a.fill("nonzero")}}},1],])
...
J.Ks=function(a,b){return J.RE(a).zH(a,b)}
...
init.metadata=[{func:"uO",args:[P.qU]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"h8",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"Vv",ret:P.a2,args:[W.cv,P.qU,P.qU,W.JQ]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"mQ",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"qu",void:true,args:[W.KV]},{func:"ZH",args:[P.KN]},{func:"iR",args:[P.KN,null]},{func:"Uw",args:[W.D8]},{func:"c7",args:[P.FK]},{func:"vS",args:[G.Ig]},];$=null
